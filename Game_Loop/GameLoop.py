...
# hđh cung cấp môi trường dạng SDL để run game tại vị trí trung tâm.
pygame.mixer.pre_init(44100, -16, 2, 512) #load âm thanh
pygame.mixer.init()
pygame.init()
game_screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
# pygame.display.set_caption('Bài tập lớn Python')
pygame.display.set_caption('Dung top 1 PTIT')
pygame.key.set_repeat(10, 20)
clock = pygame.time.Clock()

font = pygame.font.SysFont('inkfree', 22, bold=pygame.font.Font.bold)


# Load ảnh

background_image = pygame.image.load('Frankie_deJong.jpg').convert()
...
ufo_2_image = pygame.image.load('F1_ufo.png').convert_alpha()
...
# blit vẽ một ảnh vào một ảnh khác.
        # vẽ nền
...
def display_game_over():
    ...
    text_line_2 = font.render('HIT ENTER FOR NEW GAME', True, WHITE)
